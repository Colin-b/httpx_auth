...
class OAuth2DeviceCodePKCE(OAuth2BaseAuth, SupportMultiAuth, BrowserAuth):
    """
    Device Code Flow with PKCE

    Describes an OAuth 2 device code flow with PKCE requests authentication.
...
class OktaDeviceCodePKCE(OAuth2DeviceCodePKCE):
    """
    Describes an Okta (OAuth 2) "Access Token" Device Code with Proof Key for Code Exchange (PKCE)
    flow requests authentication.
    """
